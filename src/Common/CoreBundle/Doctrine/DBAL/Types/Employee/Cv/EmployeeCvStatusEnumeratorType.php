...
/**
 * Class EmployeeCvStatusEnumeratorType.
 */
class EmployeeCvStatusEnumeratorType extends AbstractEnumeratorType
{
    /**
     * @return string
     */
    ...
    {
        return 'employee_cv_status_enum';
    }

    /**
     * @param int $value
     *
     * @return EmployeeCvStatusEnum
     */
    protected function createEntity($value)
    {
        return EmployeeCvStatusEnum::create($value);
    }
}
