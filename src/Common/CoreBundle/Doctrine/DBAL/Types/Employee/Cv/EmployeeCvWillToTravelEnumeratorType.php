...
/**
 * Class EmployeeCvWillToTravelEnumeratorType.
 */
class EmployeeCvWillToTravelEnumeratorType extends AbstractEnumeratorType
{
    /**
     * @return string
     */
    ...
    {
        return 'employee_cv_will_to_travel_enum';
    }
    ...
    {
        return EmployeeCvWillToTravelEnum::create($value);
    }
}
