...
/**
 * Class MigrationFrequencyEnumeratorType.
 */
class MigrationFrequencyEnumeratorType extends AbstractEnumeratorType
{
    /**
     * @return string
     */
    ...
    {
        return 'migration_frequency_enum';
    }
    ...
    {
        return MigrationFrequencyEnum::create($value);
    }
}
