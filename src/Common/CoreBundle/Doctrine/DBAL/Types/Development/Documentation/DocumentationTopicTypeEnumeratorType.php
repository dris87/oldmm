...
/**
 * Class DocumentationTopicTypeEnumeratorType.
 */
class DocumentationTopicTypeEnumeratorType extends AbstractEnumeratorType
{
    /**
     * @return string
     */
    ...
    {
        return 'development_documentation_topic_type_enum';
    }

    /**
     * @param int $value
     *
     * @return DocumentationTopicTypeEnum|static
     */
    protected function createEntity($value)
    {
        return DocumentationTopicTypeEnum::create($value);
    }
}
