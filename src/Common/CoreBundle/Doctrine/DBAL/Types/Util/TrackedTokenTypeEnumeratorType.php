...
/**
 * Class TrackedTokenTypeEnumeratorType.
 */
class TrackedTokenTypeEnumeratorType extends AbstractEnumeratorType
{
    /**
     * @return string
     */
    ...
    {
        return 'tracked_token_type_enum';
    }

    /**
     * @param int $value
     *
     * @return TrackedTokenTypeEnum
     */
    protected function createEntity($value)
    {
        return TrackedTokenTypeEnum::create($value);
    }
}
