...
/**
 * Class TrackedTokenStatusEnumeratorType.
 */
class TrackedTokenStatusEnumeratorType extends AbstractEnumeratorType
{
    /**
     * @return string
     */
    ...
    {
        return 'tracked_token_status_enum';
    }

    /**
     * @param int $value
     *
     * @return TrackedTokenStatusEnum
     */
    protected function createEntity($value)
    {
        return TrackedTokenStatusEnum::create($value);
    }
}
