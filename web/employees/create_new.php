...
<title>Létrehozás - mumi.hu</title>
<style>
    ...
    <div class="row">
        <div  class="col-8 d-flex">
            ...
            <div class="menu col-9" class="col-10" style="top: 10px;">
                <ul>
                  <li style="margin-right: 5px;"><a href="index.php">Szűrés</a></li>
                  <li><a href="create.php" class="selected">Rögzítés</a></li>
...
<div class="container-fulid mt-2 border p-3 bg-light">
            <form class="form-horizontal" id="idForm" action="saveEmployee.php" method= "POST">
                ...
                <div class="form-group">
                      <label><span style="font-weight:bold;text-transform:uppercase;">Kategória:</span></label>
                        <select class="form-select" id="select-categories" required name="categories[]" multiple="multiple" placeholder="Válassz egy kategóriát..." style="border:2px solid #1C75BC !important;">
                ...
                <div class="form-group">
                      <label><span style="font-weight:bold;text-transform:uppercase;">Születési dátum:</span></label>
                        <input class="form-control" type="date" name="birthday" value="" pattern="\d{4}-\d{2}-\d{2}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="cv_url" value="">
                </div>
                <div class="form-group">

                          <label><span style="font-weight:bold;text-transform:uppercase;">Megjegyzés: </span></label>
                            <textarea name="comment" rows="4" cols="50" style="width:100%;"></textarea>

                </div>
                <div id="error" class="alert alert-danger d-none">
                </div>
                <div id="success" class="alert alert-success d-none">
                  <strong>Új felhasználó létrehozása sikeres!</strong> Az oldal 5 másodpercen belül frissül.
                </div>
                <div class="form-group">
                    <button id="submit-button" style="font-family: 'Barlow', sans-serif;text-transform: uppercase;background-color: #1C75BC;color:#ffffff;font-weight:bold;border-radius: 5px;padding: 10px;border:none;cursor:pointer;">Munkavállaló létrehozása</button>
                </div>
            </form>
  ...
  <script>
        ...
        $("#name").on('keyup', function(e) {
            const regEx1 = /[^A-Za-z ÁÉÚŐÓÖŰÜáéúőóüöű.\-]$/;
   ...
   $("#moving").on('click', function(e) {
       if($(this).is(':checked')) {
          $("#moving_box").removeClass('d-none');
       } else {
         $("#moving_box").addClass('d-none');
       }
    });
   ...
   $('#telephone').on('change', function(e) {
        ...
        $.ajax({
            ...
            data: 'telephone=' +  $('#telephone').val(), // serializes the form's elements.
            //contentType: "application/json; charset=utf-8",
            dataType:"JSON",
            success: function(data)
            {
