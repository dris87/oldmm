  ...
  <form class="w-100" id="idForm" method= "POST">
    <div class="container-fluid mt-2 border p-3 bg-light">
        ...
        <div class="collapse" id="collapseExample">
            ...
            <div class="row">
                <div class="col-md-8 form-group">
                            <label><span style="font-weight:bold;text-transform:uppercase;">Cég hírdetés kiválasztása:</span></label>
                            <select class="form-select" id="select-offer" name="offer[]" multiple="multiple" placeholder="Válassz egy hirdetést...">
                                 <option value="" style="padding:10px 5px;">Válassz egy hírdetést...</option>
                            <?php 
                            foreach ($offerList as $offer) {
                                ?>
                                <option value="<?php echo $offer['offer_id']; ?>"><?php echo $offer['offer']; ?></option>
                             <?php 
                            }
                            ?>
                          </select>
        ...
        <div class="row align-center">
            ...
            <div class="col m-auto">
                <div class="border mw-100 p-2 d-inline-block font-weight-bold bg-white" style="font-weight: normal !important;text-transform:uppercase;">
                    Összes érdeklődés: <span id="count2" style="font-weight:bold;"></span>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
  <div id="result" style="display:none;">
      <div  style="display:none;padding:20px;background-color:#1C75BC; color:#ffffff;display:flex !important; ">
        ...
        <div style="margin-left:25px;font-weight:bold;"><span id="count"></span> db érdeklődés</div>
      </div>
  </div>
</div>
  ...
  <script>
           ...
           $('#table').dataTable( {
                ...
                "columns": [
                    ...
                    { "data": "offer", title: "Hirdetés", sortable: true},
                    { "data": "cv_url" , title: "CV", sortable: false },
                    { "data": "created_at" , title: "Jelentkezés", sortable: true },
