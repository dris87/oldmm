...
<div class="container-fulid mt-2 border p-3 bg-light">
            ...
            <form class="form-horizontal" id="idForm" action="saveEmployee.php" method= "POST" enctype="multipart/form-data">
                ...
                <!-- Anti-bot mező - fontos hogy ez ne legyen kitöltve -->
                <div class="important-field">
                    <input type="text" name="company_website" id="company_website" autocomplete="off" tabindex="-1" placeholder="Your company website">
                </div>
                ...
                <div class="form-group">
                      <label><span style="font-weight:bold;text-transform:uppercase;">Város:</span></label>
                        <select class="form-select" id="select-state" name="states" placeholder="Válassz egy települést..." required>
