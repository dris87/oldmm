...
$csvs = getCvs($con, $cities, $categories, $counties, $name, $email, $telephone , $birthday_over , $birthday_down, $traveling, $foreigner, $languages, $drivings, $sources);
$data = [];
if($_GET['m'] === "q") {
...
function getCvs($con, $cities, $categories, $counties, $name, $email, $telephone , $birthday_over , $birthday_down, $traveling, $foreigner, $languages, $drivings, $sources) {
